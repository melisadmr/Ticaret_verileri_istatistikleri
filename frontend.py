...
# Görseli yerleştir
    ...
    def open_help_screen(self):
      ...
      help_label = tk.Label(self.help_screen, text="Bu uygulama ile Dünya Bankası verilerini\n görselleştirebilirsiniz.\n\nGRAFİK OLUŞTUR: Yıl aralığını seçip,\n grafik türünü belirledikten sonra ticaretin\n GSYH'ya oranını görselleştirir.\n\nVERİ ANALİZİ: Seçtiğiniz yıl aralığında ticaretin GSYH'ya\n oranının istatistiksel analizini yapar.\n\nTAHMİN YAP: Gelecek yıllara dair ticaretin GSYH'ya oranı\n için tahminlerde bulunur.", font=("Arial", 12), justify="left" ,bg="orange")
    ...
    def open_selection_window(self):
        ...
        self.selection_window.geometry("300x150")
        
        label = tk.Label(self.selection_window, text="Veri kaynağını seçin:")
        label.pack(pady=10)
        ...
        central_bank_button = tk.Button(self.selection_window, text="Merkez Bankası Verileri", 
                                        command=self.open_central_bank_screen)
